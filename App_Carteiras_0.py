...
carteira.append( InvestimentoPreFixado(capital, prazo, 12.51, aporte1, diaZero=date.today(), name='XP Investor 30 FIC FIA 12,51% a.a.') )
carteira.append( InvestimentoPreFixado(capital, prazo, 10.02, aporte1, diaZero=date.today(), name='CDB pre 10,02% a.a.', IR=True) )
carteira.append( InvestimentoPosFixado(capital, prazo, aporte1, cdi, diaZero=date.today(), name='CDB pre 119% CDI', IR=True) )
